...
export default function Navbar() {
  ...
  return (
    <>
      <motion.nav
        className={`fixed left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'top-0' : 'top-9'} ${location.pathname === '/' ? (scrolled ? 'glass-navbar' : 'bg-transparent') : 'glass-navbar'}`}
