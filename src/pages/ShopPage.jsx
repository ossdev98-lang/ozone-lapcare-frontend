    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/40">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-16">
            <div className="max-w-3xl">
              <motion.span initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-bold text-cyan-100 border border-white/15 backdrop-blur-md">
                <FiGrid className="w-4 h-4" /> Ozone Lapcare store
              </motion.span>
              ...
              <motion.p initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.16 }} className="mt-4 text-slate-300 leading-relaxed max-w-2xl">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
          <div className={`${filterShell} p-4 lg:p-5 mb-6`}>
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div>
                ...
                <h2 className="mt-1 text-xl font-black text-slate-900">All Products</h2>
              </div>

              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                <button onClick={() => setShowFilters(true)} className="lg:hidden inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3 text-sm font-bold text-slate-700 relative">
